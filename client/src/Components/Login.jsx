...
function Login() {
  ...
  const [showAlert, setShowAlert] = useState(false);     // incorrect password
  const [ showAlert1 , setShowAlert1] = useState(false);   // incorrect email
  ...
  axios.post('https://home-care-backend-topaz.vercel.app/login', { email, password })
  .then(result => {
    console.log(result);
